...
public class UserListCtl extends BaseCtl {
	...
	protected BaseBean populateBean(HttpServletRequest request) {
		...
		System.out.println("populatebean fname" + bean.getFirstName());
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("pageno or page size set kiya");
...
//	        get the selected checkbox ids array for delete list
		...
		System.out.println("populetbean , operation get kiya, model ka object bnaya");
...
System.out.println(bean.getFirstName());
		try {
			...
			System.out.println("2.nextlist" + list);
            
			System.out.println("nextlist set krege");
			...
			System.out.println("list,pageno,pagesize set kiya or forward get kiya");
