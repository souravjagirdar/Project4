...
public class UserRegistrationCtl extends BaseCtl {
	...
	protected boolean validate(HttpServletRequest request) {
		System.out.println("user regi validate method");
		...
		if (DataValidator.isNull(request.getParameter("firstName"))) {
			System.out.println("user regist 1");
		...
		if (DataValidator.isNull(request.getParameter("lastName"))) {
			System.out.println("user regist 2");
		...
		if (DataValidator.isNull(login)) {
			System.out.println("user regist 3");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (OP_SIGN_UP.equalsIgnoreCase(op)) {
			...
			try {
				System.out.println("model ki register me jayega");
				long pk = model.registerUser(bean);
				System.out.println("id set krega");

				bean.setId(pk);
				ServletUtility.setSuccessMessage("User Successfully Register", request);
				System.out.println("msg forward krega successfull ka get view pr ");
				ServletUtility.forward(getView(), request, response);
				return;
				...
				log.error(e);
				System.out.println("duplicaterecord exception throw hua");
	...
	protected String getView() {
		System.out.println("user get view method chli or msg vie pr show hua");
