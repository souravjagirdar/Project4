...
<body>
	<jsp:useBean id="bean" class="in.co.pro4.bean.TimeTableBean" scope="request"></jsp:useBean>
		...
		<center>
			...
			<table border="1" width="100%" align="center" cellpadding=6px cellspacing=".2">
				...
				<tr align="center">
					...
					<td>
						<a href="TimeTableCtl?id=<%=bean.getId()%>"<%if (userBean.getRoleId() == RoleBean.STUDENT) {%>
